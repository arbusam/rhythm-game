  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 dark:bg-gray-900">
      ...
      <footer className="fixed bottom-0 left-0 w-full">
        <div className="flex items-center justify-between bg-gray-100 px-4 py-6 md:flex md:items-center md:justify-between dark:bg-gray-700">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-300">
            © 2024 <a href="https://flowbite.com/">Arhan Busam</a>. All Rights
            Reserved.
          </span>
